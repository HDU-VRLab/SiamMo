...
class DenseEncoder(nn.Module):
    ...
    def __init__(self, sparse_shape):
        ...
        self.conv1_1 = ConvReluBN3d(3, 16)
        self.conv1_2 = ConvReluBN3d(16, 16)
        self.down1 = ConvReluBN3d(16, 32, 2)

        self.conv2_1 = ConvReluBN3d(32, 32)
        self.conv2_2 = ConvReluBN3d(32, 32)
        self.down2 = ConvReluBN3d(32, 64, 2)

        self.conv3_1 = ConvReluBN3d(64, 64)
        self.conv3_2 = ConvReluBN3d(64, 64)
        self.down3 = ConvReluBN3d(64, 128, 2)

        self.conv4_1 = ConvReluBN3d(128, 128)
        self.conv4_2 = ConvReluBN3d(128, 128)
    ...
    def forward(self, voxel_features, coors, batch_size):
        ...
        x = self.conv1_1(input_sp_tensor.dense())
        x = self.conv1_2(x)
        x = self.down1(x)
        ...
        x = self.conv4_1(x)
        spatial_features = self.conv4_2(x)
...
class ConvReluBN3d(nn.Sequential):

    def __init__(self, in_channels, out_channels, stride=1, groups=1):
        super().__init__(
            nn.Conv3d(in_channels, out_channels, 3, stride, 1, bias=False, groups=groups),
